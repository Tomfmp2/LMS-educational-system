export function renderDetalleCurso(codigoCurso) {
  ...
  container.innerHTML = `
    <style>
      ...
      #section-detalle-curso .modulo-header:hover {
        opacity: 0.8;
      }
      ...
      #section-detalle-curso .modulo-toggle {
        display: inline-flex;
        align-items: center;
      ...
      #section-detalle-curso .modulo-header.collapsed .modulo-toggle {
        transform: rotate(-90deg);
      }
      #section-detalle-curso .modulo-info-container {
        flex: 1;
        display: flex;
        flex-direction: column;
      }
      #section-detalle-curso .modulo-content {
        max-height: 2000px;
        overflow: hidden;
      ...
      #section-detalle-curso .modulo-content.hidden {
        max-height: 0;
        opacity: 0;
        margin-top: 0;
        padding-top: 0;
    ...
    modulosDelCurso.forEach(modulo => {
      ...
      html += `
        <div class="modulo-card">
          <div class="modulo-header collapsed" data-toggle-mod="${modulo.codigo}">
            <div class="modulo-toggle">▼</div>
            <div class="modulo-info-container">
              <h3>${modulo.nombre}</h3>
              <span class="modulo-codigo">${modulo.codigo}</span>
            </div>
          </div>

          <div class="modulo-content hidden" data-content-mod="${modulo.codigo}">
  ...
  // Agregar eventos toggle para módulos
  container.querySelectorAll('[data-toggle-mod]').forEach(header => {
    header.addEventListener('click', () => {
      const modCodigo = header.dataset.toggleMod;
      const content = container.querySelector(`[data-content-mod="${modCodigo}"]`);
